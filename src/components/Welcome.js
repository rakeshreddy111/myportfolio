        ...
        return(
            ...
            <img src={profilepic} alt="profilepic" className="main-pic"/>
                ...
                <div className="d-flex justify-content-center parent-div">
                 <a href="https://drive.google.com/open?id=1OZ6JCpW2N1QKxueU8ISoxlGj-Mg5ARa_" target="_blank" rel="noopener noreferrer"><button className="button resume-button">Resume <i className="fa fa-file-pdf-o" aria-hidden="true"/></button></a>
                 </div>
                 </h1>
